...
bool
utf8_helper::UTF8Helper::isBlank(char32_t c)
{
...
bool
utf8_helper::UTF8Helper::isBlank(const std::u32string& aStr)
{
...
bool
utf8_helper::UTF8Helper::isNewLine(char32_t c)
{
  std::u32string sz = std::u32string() + c;
...
bool
utf8_helper::UTF8Helper::isNewLine(const std::u32string& aStr)
{
...
std::u32string
utf8_helper::UTF8Helper::toUTF8String(const std::string& aStr)
{
  std::wstring_convert<std::codecvt_utf8<char32_t>, char32_t> convert;
...
std::string
utf8_helper::UTF8Helper::toByteString(const std::u32string& aStr)
{
  std::wstring_convert<std::codecvt_utf8<char32_t>, char32_t> convert;
